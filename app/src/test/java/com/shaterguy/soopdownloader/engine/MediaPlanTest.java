...
public class MediaPlanTest {
    ...
    @Test public void acceptsCatchStoryAndPreservesSelectionQuery() throws Exception {
        ...
        assertEquals("https://vod.sooplive.com/player/793663/catchstory?o=1&o=3",input.url);
    }
